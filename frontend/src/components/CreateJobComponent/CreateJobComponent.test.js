...
//ok
    ...
    it("shows error for invalid date range", async () => {
        ...
        // Date inputs can use fireEvent.change directly
        fireEvent.change(screen.getByTestId("since-date-input"), { target: { value: "2023-12-31" } });
        fireEvent.change(screen.getByTestId("until-date-input"), { target: { value: "2023-01-01" } });
